...
- [x] T26C 验证单次模型正文并部署批准模板
  ...
  - 2026-09-13本轮新候选基线核对：重新取 `5446972a5695652a595e44a2696ea29e451202e4` 的 `minimaxh3.txt`（10,756 bytes、86行）及同内容 `T47-deployment-proposal.txt`；当前工作树正文、基线、提案逐字相等，production renderer 使用 `T26C-clip2-20260911_122039` 冻结输入回放原请求逐字相等，`script2assets/script2shots/zimage` 相对基线未变，网络/生产写入为0。原始证据 `.work/c012/T26C-baseline-validation-20260913.*`。上一版 12,478-byte 候选及其失败记录保留为历史；接下来以该基线只做授权的最小措辞候选，尚未执行新模型调用。
